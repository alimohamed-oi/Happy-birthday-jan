...
const SmallLetter = () => {
    ...
    <div className="small-rajib-paper-content">
        ...
        <p>Hi Rozz,<br /><br /> اتمني الهديه الصغننه دي تعجبك بجد حقيقي لحد الان ملقتش حاجهمختلفه اعملها ليكي ولكن حيت دي هتبقي كيوت فاعملتها (متقلقيش لسه الكوبايه الخشب بتاعتك)<br /><br />Bimbo</p>
    </div>
