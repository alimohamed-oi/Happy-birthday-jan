                ...
                <div className="card1">
                    <div className="cover-text-wrapper">
                        <h4 className="username">
                            Dear Janjon<span className="underline"></span>
                        </h4>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            <article style={{ marginBottom: '8px' }}>Happy Birthday, janjon </article>
                            <article style={{ marginBottom: '10px' }}>كل سنه وانتي طيبه يا جنجوونه وعقبال سنين كتيير وانت كويسه وطيبه وكل حاجه حلوه ، اتمني ليكي السنه دي تبقي احلي من السنين اللي قبلها وتعملي اللي نفسك تعمليه ايا كان هو ايه </article>
                            <article style={{ marginBottom: '10px' }}>واتمني ليكي حياه مستقره كده مفيش اي خوازيق تيجي تعكرلك مزاجك لاي سبب ، واتمني وجودي ميكونش رخم لانه لو رخم فانا ستيل قاعدلك</article>
                            <article style={{ marginBottom: '10px' }}>والف سلامه عليكي مكنتش اتمني انك تقضي عيد ميلادك فالبيت كده بس خيير متعوضه بعدد كده ان شاء الله</article>
                            <article style={{ marginBottom: '10px' }}>هسيبك اليوم تتبسطي فيه بطريقتك واتمني جدا اكون موجود السنه الجايه واعملك واحده غير دي تبقي احلي من دي كمان ، كل سنه وجنجون طيبه طيبه</article>
                        </div>
