...
const LoveLetter = () => {
    const lettersData = [
        ...
        },
        {
            id: 2,
            name: "Bimbo",
            msg: "I hope I’ll still be here next year so I can write another challenge for us to complete one more year together.",
        },
        {
            id: 3,
            name: "Bimbo",
            msg: "Even from the short time we talked, I’m really convinced that you’re such a special person.",
        },
        {
            id: 4,
            name: "Bimbo",
            msg: "Sorry if this gift is simple. I really tried.",
        },
        {
            id: 5,
            name: "Bimbo",
            msg: "And by the way, don’t think I’ll become nice after giving you this. I’ll still annoy you exactly the same, maybe even more.",
        },
        {
            id: 6,
            name: "Bimbo",
            msg: "Now please become well, You've become ill for along time",
        },
        {
            id: 7,
            name: "Bimbo",
            msg: "Happy Birthday JanJon.",
        },
        {
            id: 8,
            name: "Bimbo",
            msg: "I honestly didn’t know what else to write here. That’s enough for you.",
        },
    ];
                ...
                <div className={`envelope ${openEnvelope ? "active" : ""}`}>
                    ...
                    <div className="munna envelope-flap text-black relative">
                        <div className='munna absolute left-1/2 top-[20%] -translate-x-1/2 flex items-center justify-center flex-col md:gap-y-2'>
                            <span className='munna font-sriracha md:text-2xl text-lg'>Extra Messages</span>
                            <span className='munna font-dancingScript md:text-3xl text-xl'>For JanJon</span>
                        </div>
                    </div>
